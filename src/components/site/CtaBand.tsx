...
export function CtaBand({
  ...
  return (
    <section className="py-16" style={{ backgroundColor: "#eeeee6" }}>
      <div className="mx-auto max-w-[1280px] px-5">
        <div className="relative overflow-hidden rounded-2xl bg-white border border-or-prestige/25 p-10 md:p-14 shadow-sm">
          ...
          <div className="flex flex-col items-start justify-between gap-8 md:flex-row md:items-center">
            <div className="max-w-[50ch]">
              ...
              <h2 className="mt-5 text-3xl font-bold uppercase text-noir">{title}</h2>
              <p className="mt-3 text-noir/65 leading-relaxed">{text}</p>
            </div>
            <div className="flex w-full flex-col gap-3 md:w-auto shrink-0">
              ...
              <a
                ...
                className="rounded-md border border-or-prestige/40 py-3 text-center font-mono text-[10px] uppercase tracking-[0.15em] text-noir/70 smooth-transition hover:bg-or-prestige/5 hover:border-or-prestige"
              >
