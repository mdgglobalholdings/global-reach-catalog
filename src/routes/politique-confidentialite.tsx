  ...
  return (
    <main>
      <article className="mx-auto max-w-[820px] px-4 sm:px-6 py-14">
        <h1 className="text-4xl uppercase leading-[0.95]">Politique de Confidentialité</h1>
        <div className="label-mono mt-6 text-amberhot">Mise à jour : {new Date().toLocaleDateString('fr-FR')}</div>

        <section className="mt-10">
          <h2 className="text-2xl uppercase mt-8 mb-3">1. Introduction</h2>
        ...
        <section className="mt-8">
          <h2 className="text-2xl uppercase mt-8 mb-3">2. Données que nous collectons</h2>
          <p className="text-noir/65 leading-relaxed">
        ...
        <section className="mt-8">
          <h2 className="text-2xl uppercase mt-8 mb-3">3. Utilisation de vos données</h2>
        ...
        <section className="mt-8">
          <h2 className="text-2xl uppercase mt-8 mb-3">4. Partage de données</h2>
          <p className="text-noir/65 leading-relaxed">
          ...
          <p className="text-noir/65 leading-relaxed mt-3">
            Nous ne vendons jamais vos données à des tiers.
          </p>
        </section>

        <section className="mt-8">
          <h2 className="text-2xl uppercase mt-8 mb-3">5. Sécurité des données</h2>
          <p className="text-noir/65 leading-relaxed">
        ...
        <section className="mt-8">
          <h2 className="text-2xl uppercase mt-8 mb-3">6. Vos droits</h2>
          <p className="text-noir/65 leading-relaxed">
        ...
        <section className="mt-8">
          <h2 className="text-2xl uppercase mt-8 mb-3">7. Cookies</h2>
          <p className="text-noir/65 leading-relaxed">
        ...
        <section className="mt-8">
          <h2 className="text-2xl uppercase mt-8 mb-3">8. Modifications</h2>
          <p className="text-noir/65 leading-relaxed">
        ...
        <section className="mt-8">
          <h2 className="text-2xl uppercase mt-8 mb-3">9. Contact</h2>
          <p className="text-noir/65 leading-relaxed">
