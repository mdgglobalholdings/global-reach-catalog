...
export function ProductCard({ product }: { product: ProductWithRelations }) {
  ...
  return (
    <Link
      ...
      className="group block overflow-hidden rounded-xl bg-white ring-1 ring-black/5 smooth-transition hover:shadow-2xl hover:-translate-y-2 hover:ring-or-prestige/20"
    >
